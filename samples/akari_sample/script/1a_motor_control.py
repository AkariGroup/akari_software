...
controller.set_joint_accelerations(pan=10, tilt=10)
print("")
time.sleep(3)
...
controller.move_joint_positions(pan=-0.7, tilt=0.3)
print("")
time.sleep(3)
